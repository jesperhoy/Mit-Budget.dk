  ...
  <bs-modal size="lg" title="Udgift / Indtægt" @submit="$emit('gem')" ref="MyModal">
    ...
    <template>
      ...
      <td><select class="form-select"></select></td>
        ...
        <tr>
          <th>Første gang:</th>
          <td><input type="date" v-model="data.start" required class="form-control w-auto" /></td>
        </tr>
        <tr>
          <th>Slutter:</th>
          <td :class="data.harslut ? null :'pad'">
            <bs-checkbox v-model="data.harslut" inline />
            <input v-if="data.harslut" type="date" v-model="data.slut" required class="form-control w-auto d-inline-block"
